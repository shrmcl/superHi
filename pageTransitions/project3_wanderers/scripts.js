...
// init the Prefetch scxript to pre-load links in the viewport
  ...
  transitions: [
    {
      ...
      custom({ current, next, trigger }) {
        // only for our next button
        // also applying barba's built-in browser "forward" trigger
      ...
      beforeEnter( {current, next, trigger} ) {
        // set text to the data attribute 'data-title' for next page 'article' container
